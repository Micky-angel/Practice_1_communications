...
# es importante compilar el codigo de client despues del server con el siguiente comando
# ros2 run doggy client
# para el codigo de client pedira 3 valores al usuario
# despues de ingresar los datos tanto el server como el client lanzaran la respuesta
